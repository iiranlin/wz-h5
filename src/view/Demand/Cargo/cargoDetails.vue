<template>
        ...
        <van-tab title="发货基本信息" name="发货基本信息">
          <van-list style="padding-bottom: 10px;">
            ...
            <div class="box-container" v-if="cargoList?.length > 0">
              ...
              <van-button v-if="params.oddNumbers == '' && params.status == 2 && userInfo.deptCode.startsWith('GYS')" @click.stop="createPosition(params.shipmentBatchNumber )" icon="plus"  type="info" plain block round>添加货运位置</van-button>
  ...
  <div class="default-button-container default-button-container-box" v-if="from === 'WaitExamineList' && params.status == 8">
