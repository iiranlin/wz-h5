        ...
        <ul class="list-ul" style="margin: 10px;">
            ...
            <van-tabs v-model="menuActiveIndex" color="#0571ff" background="#eef6ff" title-active-color="#0571ff"
                ...
                <van-tab title="物流信息" name="物流信息">
                   ...
                   <div v-if="!logistics.oddNumbers">
                    <div class="tab-div">
                        ...
                        <van-row class="th-rows" v-for="item in logistics.materialTrackMessageDTOS" :key="item.id">
                ...
                <van-tab title="发货物资明细" name="发货物资明细">
                    <div v-if="logistics.materialCirculationDetailsTableDTOS && logistics.materialCirculationDetailsTableDTOS.length>0">
                            <van-list>
                            <div class="box-container"
