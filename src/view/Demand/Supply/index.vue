...
export default {
    ...
    data() {
        ...
        { text: '未确认', value: '2', imgPath: '/static/icon-send-midway.png' },
        { text: '已确认', value: '3', imgPath: '/static/Icon_notarize.png' },
        { text: '供货中', value: '4', imgPath: '/static/icon-send-midway.png' },
        { text: '已撤回', value: '5', imgPath: '/static/Icon_revoke.png' },
        { text: '已完成', value: '6', imgPath: '/static/icon-send-success.png' },
