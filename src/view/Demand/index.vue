                        ...
                        <van-list 
                            ...
                            <div v-for="(item,index) in 10" :key="index" class="box-container" @click="handleAllItemClick(item)">
                                <ul class="list-ul">
                                    ...
                                    <li class="li-status">
                                        <van-tag type="primary" round size="medium">未确认</van-tag>
                                ...
                                <div class="list-ul-button">
                                    <van-button class="button-info" plain round type="info" @click="handleSendGoodsClick()">发货</van-button>
                                    <van-button class="button-info" round type="info" @click="handleLookClick()">物流查看</van-button>
                                       <van-button class="button-info" plain round type="info" @click="handleSupplyClick()">供应详情</van-button>
                                    <van-button class="button-info" round type="info" @click="handleConfirmClick()">确认需求</van-button>
                                </div>
                            </div>
                        </van-list>
                    </van-pull-refresh>
