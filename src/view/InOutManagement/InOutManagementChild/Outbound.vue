    ...
    <div class="outbound-mian">
      <van-form @submit="outboundClick" label-align="left" label-width="180px">
        ...
        <div class="box-container">
          ...
          <file-upload-view v-if="queryType === 'submit'" uploadTitle="领料单" :fileList="fileList" businessType="01"></file-upload-view>
          <file-download-view v-else uploadTitle="领料单" :fileList="fileList"></file-download-view>
        </div>
