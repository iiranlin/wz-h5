...
<van-field label="退货数量" placeholder="请输入数量" required clearable input-align="right">
  <template #input>
    ...
    <div class="detail-base-info detail-base-info-edited" style="margin-top: 0; margin-bottom: 5px;" v-if="queryType == 'submit' && sectionInfo.defaultRadio == '2'">
      ...
      <p class="box-container-p" v-if="!sectionInfo.fileList03?.length"><span class="li-span-red">*</span>必填项，请选择文件上传，支持jpg、png、jpeg、pdf格式</p>
      <file-upload-view :maxCount="99" accept=".jpg,.png,.jpeg,.pdf" :fileList="sectionInfo.fileList03 || []" businessType="01" class="outbound-field-uploader" />
    </div>
